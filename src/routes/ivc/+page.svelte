<script lang="ts">
	...
	$: prevAppointmentPlaceholder = isEnglish ? 'Select previous appointment' : '選擇時段';
	...
	function updateButtonsState() {
		if (selectedTab === 'newAppointment') {
			disableSubmitBtn = !fullName || !telephone || !selectedDate || !selectedTime;
		} else {
			// search button disable logic
			disableSearchBtn = !fullName || !telephone;
			if (selectedEditType === 'update') {
				disableSubmitBtn =
					!fullName || !telephone || !selectedPrevAppointment || !selectedDate || !selectedTime;
			} else {
...
<form class={styles.form}>
	...
	<div class={styles.formGroup}>
		<label for="fullName">{$t('ivc.field.name.label')}</label>
		<input id="fullName" bind:value={fullName} on:input={updateFormState} />
	</div>
	<div class={styles.formGroup}>
	...
	<div class={styles.buttonContainer} class:dn={selectedTab === 'newAppointment'}>
		<button
			class={styles.button}
	...
	<div class={styles.formGroup} class:dn={selectedTab === 'modifyAppointment' && hideNewOptions}>
